...
<div class="container">
      ...
      <div class="register">
          <div class="container">
              <i class="fa fa-line-chart extra-large-chart-icon" aria-hidden="true"></i>
              <h2>Hello , Investor!</h2>
              <p>SignIn to view your  Dashboard, Charts, Metrics and many more.....</p>
              <button onClick={() => loginWithRedirect()}>Register <i class="fa fa-arrow-circle-right"></i></button>
          </div>
      </div>  
    </div>
  ))
